...
class UserSyncProcessorTest extends AbstractSyncProcessorTests
{
    ...
    protected function initDTO()
    {
        ...
        $this->dto->setAuthMode(IUserDTO::AUTH_MODE_ILIAS);
     ...
     */
    public function test_create_user_with_different_login_name_modes(string $mode, string $expectedLoginName)
    {
    ...
    {
        $this->originProperties->setData([IUserProperties::ACTIVATE_ACCOUNT => false]);
        $this->initDataExpectations();
    ...
    public function test_delete_user_mode_none()
    {
        ...
        $this->originProperties->setData([IUserProperties::DELETE => IUserProperties::DELETE_MODE_NONE]);
    ...
    {
        $this->setDefaultExpectationsForDeletionOfILIASUser();
        $this->originProperties->setData([IUserProperties::DELETE => IUserProperties::DELETE_MODE_INACTIVE]);
        $this->originImplementation->shouldReceive('beforeDeleteILIASObject');
        $this->originImplementation->shouldReceive('afterDeleteILIASObject');
    ...
    {
        $this->setDefaultExpectationsForDeletionOfILIASUser();
        $this->originProperties->setData([IUserProperties::DELETE => IUserProperties::DELETE_MODE_DELETE]);
        $this->originImplementation->shouldReceive('beforeDeleteILIASObject');
        $this->originImplementation->shouldReceive('afterDeleteILIASObject');
    ...
    {
        return [
            [IUserOriginConfig::LOGIN_FIELD_SHORTENED_FIRST_LASTNAME, 'j.doe'],
            [IUserOriginConfig::LOGIN_FIELD_EMAIL, 'john.doe@example.com'],
            [IUserOriginConfig::LOGIN_FIELD_EXT_ACCOUNT, 'john.doe.external'],
            [IUserOriginConfig::LOGIN_FIELD_EXT_ID, 'extidofjohndoe'],
            [IUserOriginConfig::LOGIN_FIELD_FIRSTNAME_LASTNAME, 'john.doe'],
            [IUserOriginConfig::LOGIN_FIELD_HUB_LOGIN, 'johndoe123'],
        ];
    }
