...
namespace srag\CustomInputGUIs\Hub2\LearningProgressPieUI;

use ILIAS\Data\Color;
use ilLearningProgressBaseGUI;
use ilLPStatus;
use srag\CustomInputGUIs\Hub2\CustomInputGUIsTrait;
use srag\DIC\Hub2\DICTrait;

/**
 * Class AbstractLearningProgressPieUI
 *
 * @package srag\CustomInputGUIs\Hub2\LearningProgressPieUI
 *
