    ...
    protected function getColumnValue(/*string*/
        ...
        switch ($column) {
            ...
            case "origin_object_type":
                $column = ilHub2Plugin::getInstance()->txt("origin_object_type_" . $row[$column]);
                break;
            ...
            case "additional_data":
                ...
                if (empty($column)) {
                    $column = ilHub2Plugin::getInstance()->txt("no_additional_data", hub2LogsGUI::LANG_MODULE_LOGS);
                }
                break;
        ...
        $this->filter_fields = [
            ...
            "origin_object_type" => [
                ...
                PropertyFormGUI::PROPERTY_OPTIONS => [
                        ...
                        return ilHub2Plugin::getInstance()->txt("origin_object_type_" . $origin_object_type);
